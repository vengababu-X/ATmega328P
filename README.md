...
| ATmega328P TOP |
| :--- | <br> [CLK] >-----------+--> [   AVR CPU CORE   ]                     | <br> [RST] >-----------+--> | - ALU / Control  |                     |
|  | - 32x8 Registers | <-> [PROG_ROM] | <br> [IRQ_TIMER] >--------+--> | - PC & IRQ Logic |     (128x16-bit)    |
| +-------+----------+ |
...
The project uses GitHub Actions to validate compilation and OpenLane ASIC flow for physical design synthesis and logic.
